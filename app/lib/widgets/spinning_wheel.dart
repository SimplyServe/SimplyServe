...
class _SpinningWheelWidgetState extends State<SpinningWheelWidget> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
  
  final List<String> _meals = [
    'Pizza', 'Burger', 'Pasta', 'Salad', 'Sushi', 'Tacos', 'Steak', 'Wrap'
  ];
  ...
  void _spinWheel() {
    ...
    final targetAngle = currentAngle - normalizedCurrentAngle + spinRotations + randomAngle;
